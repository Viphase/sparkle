...
Use them when editing matching areas:
- Go/domain/storage code: `.claude/rules/go-architecture.md`
- TUI screens/components/themes: `.claude/rules/tui-style.md`
- AI prompts/provider code: `.claude/rules/ai-prompting.md`
- Markdown storage/tracking: `.claude/rules/storage-and-tracking.md`
